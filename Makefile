# Formatters - Generic, reusable code formatting module for Go applications.
...
challenge:
	../challenges/scripts/formatters_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Formatters - Generic, reusable code formatting module for Go applications."
	@echo ""
	@echo "Build & Test:"
