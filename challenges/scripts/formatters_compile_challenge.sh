#!/usr/bin/env bash
# formatters_compile_challenge.sh - Validates Formatters module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.formatters"
if grep -q "^module digital.vasic.formatters$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.formatters"
else
